...
public class RecipeGenreEntity {
	 ...
	 */
	public static List<RecipeGenreInfo> createRecipeGenreInfoList(List<RecipeGenreEntity> recipeGenreEntityList) {
		// StreamAPI を使うとこうなります。
		return recipeGenreEntityList.stream().map(RecipeGenreEntity::createRecipeGenreInfo).toList();
